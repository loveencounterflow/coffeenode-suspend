...
(function() {
  ...
  suspend = function(generator, options) {
    ...
    * more utilities possible in the future.
     */
    var do_throw, ref;
    do_throw = (ref = options != null ? options['throw'] : void 0) != null ? ref : true;
    return function() {
      var iterator;
  ...
  suspend.collect = function() {
    var P, Z, finish, handler, has_finished, i, method;
    method = arguments[0], P = 3 <= arguments.length ? slice.call(arguments, 1, i = arguments.length - 1) : (i = 1, []), handler = arguments[i++];
    ...
    * When termination has been signalled and after an error has occurred, no more callbacks are performed.
    ...
    method.apply(null, slice.call(P).concat([function() {
      var data, error, first_item;
      error = arguments[0], data = 2 <= arguments.length ? slice.call(arguments, 1) : [];
      if (has_finished) {
